            ...
            <div class="modal-dialog">
                <div class="modal-content my-modal">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5 text-white" id="exampleModalLabel"><span class="text-danger">Deleting</span> the Technology {{ $technology->title }}</h1>
                    ...
                    <div class="modal-footer">
                        ...
                        <form 
                            ...
                            {{-- onsubmit="return confirm('Are you sure you want to delete {{ $technology->title }}?')" --}}>
                            @csrf
