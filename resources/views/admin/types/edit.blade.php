...
<div class="d-flex justify-content-end pt-3">
    <a href="{{ route('admin.types.index') }}" class="btn my-badge text-white fw-bolder">
    ...
    <div class="col py-4 text-white">
        ...
        <form action="{{ route('admin.types.update', ['type' => $type->id]) }}" method="POST"> 
            ...
            <div class="mb-3">
                ...
                <input value="{{ old('title', $type->title) }}" type="text" class="form-control text-white" @error('title') is-invalid @enderror id="title" name="title" placeholder="Add your updated Type Title..." maxlength="255" required>
                @error('title')
